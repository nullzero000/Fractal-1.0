export const HEBREW_DATA = {
  'א': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(255, 255, 255)', 
        ort: 'rgb(200, 200, 200)', 
        akashic: 'rgb(173, 255, 47)' // Corregido
    }, 
  ...
  'ג': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(220, 20, 60)',   
        ort: 'rgb(255, 0, 0)',     
        akashic: 'rgb(228, 0, 124)' // Corregido
    },
    energy: 'Canal.', 
  ...
  'ד': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(0, 128, 0)',     
        ort: 'rgb(255, 165, 0)', 
        akashic: 'rgb(149, 53, 83)' // Corregido
    },
    energy: 'Contención.', 
  ...
  'ה': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(0, 0, 139)',     
        ort: 'rgb(139, 0, 0)', 
        akashic: 'rgb(135, 206, 235)' // Corregido
    },
    energy: 'Aliento.', 
  ...
  'ו': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(255, 255, 255)', 
        ort: 'rgb(100, 50, 0)', 
        akashic: 'rgb(220, 20, 60)' // Corregido
    }, 
    energy: 'Conector.', 
  ...
  'ז': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(255, 140, 0)',   
        ort: 'rgb(192, 192, 192)', 
        akashic: 'rgb(65, 105, 225)' // Corregido
    }, 
    energy: 'Espada.', 
  ...
  'ח': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(128, 0, 0)',     
        ort: 'rgb(0, 0, 128)', 
        akashic: 'rgb(255, 215, 0)' // Corregido
    }, 
    energy: 'Vida.', 
  ...
  'ט': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(255, 255, 255)', 
        ort: 'rgb(255, 215, 0)', 
        akashic: 'rgb(200, 162, 200)' // Corregido
    }, 
    energy: 'Bondad.', 
  ...
  'י': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(0, 0, 0)',       
        ort: 'rgb(10, 10, 10)', 
        akashic: 'rgb(255, 248, 220)' // Corregido
    }, 
    energy: 'Punto.', 
  ...
  'כ': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(0, 255, 0)',     
        ort: 'rgb(139, 69, 19)', 
        akashic: 'rgb(138, 43, 226)' // Corregido
    }, 
    energy: 'Palma.', 
  ...
  'ל': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(255, 255, 0)',   
        ort: 'rgb(200, 200, 255)', 
        akashic: 'rgb(204, 119, 34)' // Corregido
    }, 
    energy: 'Enseñanza.', 
  ...
  'מ': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(0, 0, 255)',     
        ort: 'rgb(0, 100, 255)', 
        akashic: 'rgb(0, 206, 209)' // Corregido
    }, 
    energy: 'Matriz.', 
  ...
  'נ': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(0, 100, 0)',     
        ort: 'rgb(47, 79, 79)', 
        akashic: 'rgb(255, 182, 193)' // Corregido
    }, 
    energy: 'Caída.', 
  ...
  'ס': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(255, 0, 255)',   
        ort: 'rgb(255, 69, 0)', 
        akashic: 'rgb(218, 112, 214)' // Corregido
    }, 
    energy: 'Apoyo.', 
  ...
  'ע': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(75, 0, 130)',    
        ort: 'rgb(0, 0, 0)', 
        akashic: 'rgb(80, 200, 120)' // Corregido
    }, 
    energy: 'Ojo.', 
  ...
  'פ': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(255, 255, 255)', 
        ort: 'rgb(255, 0, 0)', 
        akashic: 'rgb(255, 105, 180)' // Corregido
    }, 
    energy: 'Boca.', 
  ...
  'צ': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(128, 0, 128)',   
        ort: 'rgb(0, 255, 255)', 
        akashic: 'rgb(144, 238, 144)' // Corregido
    }, 
    energy: 'Justo.', 
  ...
  'ק': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(220, 20, 60)',   
        ort: 'rgb(100, 100, 100)', 
        akashic: 'rgb(175, 238, 238)' // Corregido
    }, 
    energy: 'Santidad.', 
  ...
  'ר': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(255, 165, 0)',   
        ort: 'rgb(139, 69, 19)', 
        akashic: 'rgb(230, 230, 250)' // Corregido
    }, 
    energy: 'Cabeza.', 
  ...
  'ש': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(255, 0, 0)',     
        ort: 'rgb(255, 69, 0)', 
        akashic: 'rgb(224, 255, 255)' // Corregido
    }, 
    energy: 'Fuego.', 
  ...
  'ת': { 
    ...
    palettes: { 
        ...
        ari: 'rgb(0, 0, 139)',     
        ort: 'rgb(0, 0, 0)', 
        akashic: 'rgb(255, 255, 224)' // Corregido
    }, 
    energy: 'Sello.', 
...
// FIX CRÍTICO: Configuración por defecto = ARI
